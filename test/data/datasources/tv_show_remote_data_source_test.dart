...
void main() {
  ...
  group('get Now Airing Tv Shows', () {
    ...
    test('should return list of Tv Show Model when the response code is 200',
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/on_the_air?$API_KEY')))
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/tv_now_airing.json'), 200));
  ...
  group('get Top Rated Tv Shows', () {
    ...
    test('should return list of tv shows model when response code is 200',
        () async {
      // arrange
      when(mockHttpClient
          .get(Uri.parse('$BASE_URL/tv/top_rated?$API_KEY'), headers: {
