...
import 'package:ditonton/domain/usecases/get_watchlist_tv_shows_status.dart'
    as _i4;
import 'package:ditonton/domain/usecases/remove_watchlist_tv_shows.dart' as _i6;
import 'package:ditonton/domain/usecases/save_watchlist_tv_shows.dart' as _i5;
...
class _FakeGetWatchlistTvShowsStatus_2 extends _i1.Fake
    implements _i4.GetWatchlistTvShowsStatus {}

class _FakeSaveWatchlistTvShows_3 extends _i1.Fake
    implements _i5.SaveWatchlistTvShows {}

class _FakeRemoveWatchlistTvShows_4 extends _i1.Fake
    implements _i6.RemoveWatchlistTvShows {}
...
class MockTvShowDetailNotifier extends _i1.Mock
  ...
  @override
  _i4.GetWatchlistTvShowsStatus get getWatchlistTvShowsStatus =>
      (super.noSuchMethod(Invocation.getter(#getWatchlistTvShowsStatus),
              returnValue: _FakeGetWatchlistTvShowsStatus_2())
          as _i4.GetWatchlistTvShowsStatus);
  @override
  _i5.SaveWatchlistTvShows get saveWatchlistTvShows => (super.noSuchMethod(
      Invocation.getter(#saveWatchlistTvShows),
      returnValue: _FakeSaveWatchlistTvShows_3()) as _i5.SaveWatchlistTvShows);
  @override
  _i6.RemoveWatchlistTvShows get removeWatchlistTvShows =>
      (super.noSuchMethod(Invocation.getter(#removeWatchlistTvShows),
              returnValue: _FakeRemoveWatchlistTvShows_4())
          as _i6.RemoveWatchlistTvShows);
  @override
  ...
  @override
  List<_i10.TvShow> get tvRecommendations =>
