...
class TvShowDetailNotifier extends ChangeNotifier {
  ...
  static const wathclistRemoveSuccessMessage = 'Removed from Watchlist';

  final GetTvShowDetail getTvShowDetail;
  final GetTvShowRecommendations getTvShowRecommendations;
  final GetWatchlistTvShowsStatus getWatchlistTvShowsStatus;
  final SaveWatchlistTvShows saveWatchlistTvShows;
  final RemoveWatchlistTvShows removeWatchlistTvShows;

  TvShowDetailNotifier({
    required this.getTvShowDetail,
    required this.getTvShowRecommendations,
    required this.getWatchlistTvShowsStatus,
    required this.saveWatchlistTvShows,
    required this.removeWatchlistTvShows,
  });
  ...
  List<TvShow> get tvRecommendations => _tvShowRecommendations;
  ...
  Future<void> addWatchlist(TvShowDetail tvShow) async {
    final result = await saveWatchlistTvShows.execute(tvShow);
  ...
  Future<void> removeFromWatchlist(TvShowDetail tvShow) async {
    final result = await removeWatchlistTvShows.execute(tvShow);
  ...
  Future<void> loadWatchlistStatus(int id) async {
    final result = await getWatchlistTvShowsStatus.execute(id);
