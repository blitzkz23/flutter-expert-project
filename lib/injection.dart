...
void init() {
  ...
  locator.registerFactory(
    () => TvShowDetailNotifier(
      ...
      getWatchlistTvShowsStatus: locator(),
      saveWatchlistTvShows: locator(),
      removeWatchlistTvShows: locator(),
    ),
  );
  locator.registerFactory(
  ...
  locator.registerLazySingleton(() => GetWatchlistTvShowsStatus(locator()));
  locator.registerLazySingleton(() => SaveWatchlistTvShows(locator()));
  locator.registerLazySingleton(() => RemoveWatchlistTvShows(locator()));
